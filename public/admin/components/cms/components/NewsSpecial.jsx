...
class NewsSpecialModal extends React.Component {
    constructor(props) {
        super(props);
                ...
                list.map((d, i) => <div key={i}>
                    ...
                    >
                        <Row>
                            ...
                            <Col span={18}>
                                <Form >
                                    <FormItem label="品牌ICON" hasFeedback {...formItemLayout}>
...
const NewsSpecialForm = Form.create()(NewsSpecialModal);
...
class NewsSpecial extends React.Component {
    ...
    render() {
        ...
        return <div>
            <CmsBaseComponent {...this.props} name="图文专题" onEdit={() => {
                self.setState({
                    visible: true
                });
            }}/>
            {visible ? <NewsSpecialForm {...FormProps}/> : ''}
        </div>
    }
}
