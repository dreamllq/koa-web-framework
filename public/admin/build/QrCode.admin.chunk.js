	...
	exports.default = _form2.default.create()(function (_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                FormItem,
	                _extends({ label: '\u573A\u666FID', hasFeedback: true }, formItemLayout),
	            ...
	            qrcodeType == 2 ? _react2.default.createElement(
	                FormItem,
	                _extends({ label: '\u8FC7\u671F\u65F6\u95F4',
	                    extra: '\u5355\u4F4D\u79D2\u3002\u6700\u5927\u4E0D\u8D85\u8FC7604800',
	                    hasFeedback: true }, formItemLayout),
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        ...
	                        case 4:
	                            ...
	                            _context.next = 9;
	                            return _webchat2.default.wechatQrcodeList({ page: page, pageSize: pageSize });
	            ...
	            return regeneratorRuntime.wrap(function del$(_context3) {
	                while (1) {
	                    switch (_context3.prev = _context3.next) {
	                        case 0:
	                            _context3.next = 2;
	                            return _webchat2.default.wechatQrcodeDel({ id: id });
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        ...
	                        case 2:
	                            _context.next = 4;
	                            return select(function (state) {
	                                return state.qrcodeModal;
	                            });
	
	                        case 4:
	                            _ref4 = _context.sent;
	                            qrcodeType = _ref4.qrcodeType;
	                            ...
	                            _context.next = 9;
	                            return _webchat2.default.wechatQrcodeYJSave(data);
	                        ...
	                        case 11:
	                            _context.next = 13;
	                            return _webchat2.default.wechatQrcodeLSSave(data);
	                        ...
	                        case 15:
	                            _context.next = 17;
	                            return put({ type: 'wechatQrcode/init' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css2 = __webpack_require__(286);
	
	var _col = __webpack_require__(285);
	
	var _col2 = _interopRequireDefault(_col);
	
	var _css3 = __webpack_require__(159);
	...
	var _QrcodeModal = __webpack_require__(705);
	
	var _QrcodeModal2 = _interopRequireDefault(_QrcodeModal);
	...
	exports.default = (0, _dva.connect)(function (_ref) {
	    var wechatQrcode = _ref.wechatQrcode,
	        qrcodeModal = _ref.qrcodeModal;
	    return { wechatQrcode: wechatQrcode, qrcodeModal: qrcodeModal };
	})(function (_ref2) {
	    var dispatch = _ref2.dispatch,
	        wechatQrcode = _ref2.wechatQrcode,
	        qrcodeModal = _ref2.qrcodeModal;
	    var page = wechatQrcode.page,
	        pageSize = wechatQrcode.pageSize,
	        list = wechatQrcode.list,
	        loading = wechatQrcode.loading,
	        total = wechatQrcode.total;
	    ...
	    var columns = [{
	        ...
	        render: function render(text, record) {
	            if (record.type == 1) {
	                ...
	                if ((0, _moment2.default)().unix() > record.create_time + record.expire_seconds) {
	                    return _react2.default.createElement(
	                        'span',
	                        null,
	        ...
	        render: function render(text, record) {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('img', { src: record.url, width: 40, height: 40 })
	            );
	        }
	    }, {
	        title: '场景ID',
	        ...
	        render: function render(text, record) {
	            return _react2.default.createElement(
	                'span',
	                null,
	                _moment2.default.unix(record.create_time).format('YYYY-MM-DD HH:mm:ss')
	            );
	        }
	    }, {
	        title: '过期时间',
	        ...
	        render: function render(text, record) {
	            return _react2.default.createElement(
	                'span',
	                null,
	                record.type == 1 ? '无过期时间' : _moment2.default.unix(record.create_time + record.expire_seconds).format('YYYY-MM-DD HH:mm:ss')
	            );
	        }
	    }, {
	        title: '操作',
	    ...
	    var QrcodeModalProps = _extends({}, qrcodeModal, {
	        onCancel: function onCancel() {
	            dispatch({ type: 'qrcodeModal/payload', payload: { visible: false } });
	        },
	        onOk: function onOk(data) {
	            console.log(data);
	            dispatch({ type: 'qrcodeModal/set', data: data });
	        }
	    });
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _button2.default,
	                        { size: 'large', style: { marginRight: 8 }, onClick: function onClick() {
	        ...
	        qrcodeModal.visible ? _react2.default.createElement(_QrcodeModal2.default, QrcodeModalProps) : ''
	    );
	});
	module.exports = exports['default'];
...
//# sourceMappingURL=QrCode.admin.chunk.js.map