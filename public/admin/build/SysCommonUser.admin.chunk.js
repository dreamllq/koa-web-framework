...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    effects: {
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        ...
	                        case 4:
	                            ...
	                            _context.next = 9;
	                            return _sys2.default.commonUserList({ page: page, pageSize: pageSize });
	            ...
	            return regeneratorRuntime.wrap(function del$(_context3) {
	                while (1) {
	                    switch (_context3.prev = _context3.next) {
	                        case 0:
	                            _context3.next = 2;
	                            return _sys2.default.commonUserDel({ id: id });
	        ...
	        ban: regeneratorRuntime.mark(function ban(_ref9, _ref10) {
	            var id = _ref9.id;
	            var put = _ref10.put;
	            return regeneratorRuntime.wrap(function ban$(_context4) {
	                while (1) {
	                    switch (_context4.prev = _context4.next) {
	                        case 0:
	                            _context4.next = 2;
	                            return _sys2.default.commonUserBan({ id: id });
	        ...
	        unban: regeneratorRuntime.mark(function unban(_ref11, _ref12) {
	            var id = _ref11.id;
	            var put = _ref12.put;
	            return regeneratorRuntime.wrap(function unban$(_context5) {
	                while (1) {
	                    switch (_context5.prev = _context5.next) {
	                        case 0:
	                            _context5.next = 2;
	                            return _sys2.default.commonUserUnBan({ id: id });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css3 = __webpack_require__(326);
	...
	exports.default = (0, _dva.connect)(function (_ref) {
	    var sysCommonUser = _ref.sysCommonUser;
	    return { sysCommonUser: sysCommonUser };
	})(function (_ref2) {
	    var dispatch = _ref2.dispatch,
	        sysCommonUser = _ref2.sysCommonUser;
	    var page = sysCommonUser.page,
	        pageSize = sysCommonUser.pageSize,
	        list = sysCommonUser.list,
	        loading = sysCommonUser.loading,
	        total = sysCommonUser.total;
	    ...
	    var columns = [{
	        ...
	        render: function render(text, record) {
	            return _react2.default.createElement('img', { src: record.cover, width: 40, height: 40 });
	        }
	    }, {
	        title: '昵称',
	        key: 'nickname',
	        ...
	        key: 'status',
	        render: function render(text, record) {
	            return record.status == 1 ? _react2.default.createElement(
	                'span',
	                null,
	        ...
	        render: function render(text, record) {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    { title: '\u786E\u8BA4\u5220\u9664\u6B64\u7528\u6237\u5417?', onConfirm: function onConfirm() {
	                ...
	                record.status == 1 ? _react2.default.createElement(
	                    _popconfirm2.default,
	                    { title: '\u786E\u8BA4\u5C01\u7981\u6B64\u7528\u6237\u5417?', onConfirm: function onConfirm() {
	                    ...
	                    _popconfirm2.default,
	                    { title: '\u786E\u8BA4\u89E3\u5C01\u6B64\u7528\u6237\u5417?', onConfirm: function onConfirm() {
...
//# sourceMappingURL=SysCommonUser.admin.chunk.js.map