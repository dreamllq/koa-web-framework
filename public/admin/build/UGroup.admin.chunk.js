	...
	exports.default = _form2.default.create()(function (_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                FormItem,
	                _extends({ label: '\u5206\u7EC4\u540D', hasFeedback: true }, formItemLayout),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    effects: {
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        ...
	                        case 2:
	                            ...
	                            data = _ref3.data;
	                            _context.next = 6;
	                            return put({ type: 'payload', payload: { list: data } });
	        ...
	        asyncGroup: regeneratorRuntime.mark(function asyncGroup(_, _ref4) {
	            var put = _ref4.put;
	            return regeneratorRuntime.wrap(function asyncGroup$(_context2) {
	                while (1) {
	                    switch (_context2.prev = _context2.next) {
	                        case 0:
	                            _context2.next = 2;
	                            return _webchat2.default.wechatUGroupAsync();
	        ...
	        deleteGroup: regeneratorRuntime.mark(function deleteGroup(_ref5, _ref6) {
	            var id = _ref5.id;
	            var put = _ref6.put;
	            return regeneratorRuntime.wrap(function deleteGroup$(_context3) {
	                while (1) {
	                    switch (_context3.prev = _context3.next) {
	                        case 0:
	                            _context3.next = 2;
	                            return _webchat2.default.wechatUGroupRemove({ id: id });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    effects: {
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        ...
	                        case 2:
	                            name = data.name;
	                            _context.next = 5;
	                            return _webchat2.default.wechatUGroupAdd({ name: name });
	                        ...
	                        case 7:
	                            _context.next = 9;
	                            return put({ type: 'wechatUGroup/init' });
	        ...
	        update: regeneratorRuntime.mark(function update(_ref4, _ref5) {
	            var data = _ref4.data;
	            var put = _ref5.put,
	                select = _ref5.select;
	                    ...
	                    switch (_context2.prev = _context2.next) {
	                        ...
	                        case 2:
	                            ...
	                            return select(function (state) {
	                                return state.wechatUGroupModal;
	                            });
	                        ...
	                        case 4:
	                            ...
	                            name = data.name;
	                            _context2.next = 9;
	                            return _webchat2.default.wechatUGroupUpdate({ id: id, name: name });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GroupModal = __webpack_require__(709);
	...
	exports.default = (0, _dva.connect)(function (_ref) {
	    var wechatUGroup = _ref.wechatUGroup,
	        wechatUGroupModal = _ref.wechatUGroupModal;
	    return { wechatUGroup: wechatUGroup, wechatUGroupModal: wechatUGroupModal };
	})(function (_ref2) {
	    var wechatUGroup = _ref2.wechatUGroup,
	        wechatUGroupModal = _ref2.wechatUGroupModal,
	        dispatch = _ref2.dispatch;
	    var list = wechatUGroup.list;
	    ...
	    var GroupModalProps = _extends({}, wechatUGroupModal, {
	        onCancel: function onCancel() {
	            dispatch({ type: 'wechatUGroupModal/payload', payload: { visible: false } });
	        },
	        onOk: function onOk(data) {
	            dispatch({ type: 'wechatUGroupModal/' + wechatUGroupModal.type, data: data });
	        }
	    });
	
	    return _react2.default.createElement(
	        'div',
	        { className: 'wechat_ugroup' },
	        _react2.default.createElement(
	            _row2.default,
	        ...
	        wechatUGroupModal.visible ? _react2.default.createElement(_GroupModal2.default, GroupModalProps) : ''
	    );
	});
	module.exports = exports['default'];
...
//# sourceMappingURL=UGroup.admin.chunk.js.map