	...
	exports.default = _form2.default.create()(function (_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                FormItem,
	                _extends({ label: '\u957F\u8FDE\u63A5', hasFeedback: true }, formItemLayout),
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        ...
	                        case 4:
	                            ...
	                            _context.next = 9;
	                            return _webchat2.default.wechatShortLinkList({ page: page, pageSize: pageSize });
	            ...
	            return regeneratorRuntime.wrap(function del$(_context3) {
	                while (1) {
	                    switch (_context3.prev = _context3.next) {
	                        case 0:
	                            _context3.next = 2;
	                            return _webchat2.default.wechatShortDel({ id: id });
	            ...
	            return regeneratorRuntime.wrap(function set$(_context) {
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        ...
	                        case 2:
	                            _context.next = 4;
	                            return _webchat2.default.wechatShortSet(data);
	                        ...
	                        case 6:
	                            _context.next = 8;
	                            return put({ type: 'wechatShortLink/init' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ShortLinkModal = __webpack_require__(708);
	
	var _ShortLinkModal2 = _interopRequireDefault(_ShortLinkModal);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = (0, _dva.connect)(function (_ref) {
	    var wechatShortLink = _ref.wechatShortLink,
	        shortLinkModal = _ref.shortLinkModal;
	    return { wechatShortLink: wechatShortLink, shortLinkModal: shortLinkModal };
	})(function (_ref2) {
	    var dispatch = _ref2.dispatch,
	        wechatShortLink = _ref2.wechatShortLink,
	        shortLinkModal = _ref2.shortLinkModal;
	    var page = wechatShortLink.page,
	        pageSize = wechatShortLink.pageSize,
	        list = wechatShortLink.list,
	        loading = wechatShortLink.loading,
	        total = wechatShortLink.total;
	    ...
	    var columns = [{
	        ...
	        render: function render(text, record) {
	            return _react2.default.createElement(
	                'a',
	                { href: record.short_link, target: '_blank' },
	                record.short_link
	            );
	        }
	    }, {
	    ...
	    var ShortLinkModalProps = _extends({}, shortLinkModal, {
	        onCancel: function onCancel() {
	            dispatch({ type: 'shortLinkModal/payload', payload: { visible: false } });
	        },
	        onOk: function onOk(data) {
	            console.log(data);
	            dispatch({ type: 'shortLinkModal/set', data: data });
	        }
	    });
	    return _react2.default.createElement(
	        'div',
	        ...
	        shortLinkModal.visible ? _react2.default.createElement(_ShortLinkModal2.default, ShortLinkModalProps) : ''
	    );
	});
	module.exports = exports['default'];
...
//# sourceMappingURL=ShortLink.admin.chunk.js.map