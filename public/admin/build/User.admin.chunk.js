	...
	exports.default = _form2.default.create()(function (_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                FormItem,
	                _extends({ label: '\u5907\u6CE8', hasFeedback: true }, formItemLayout),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _webchat = __webpack_require__(284);
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        ...
	                        case 4:
	                            ...
	                            remark = data.remark;
	                            _context.next = 9;
	                            return _webchat2.default.wechatUserSetRemark({ remark: remark, id: id });
	                        ...
	                        case 11:
	                            _context.next = 13;
	                            return put({ type: 'wechatUser/init' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    effects: {
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        ...
	                        case 4:
	                            ...
	                            _context.next = 9;
	                            return _webchat2.default.wechatUserList({ page: page, pageSize: pageSize });
	        ...
	        asyncUser: regeneratorRuntime.mark(function asyncUser(_, _ref7) {
	            var put = _ref7.put;
	            return regeneratorRuntime.wrap(function asyncUser$(_context3) {
	                while (1) {
	                    switch (_context3.prev = _context3.next) {
	                        case 0:
	                            _context3.next = 2;
	                            return _webchat2.default.wechatUserAsyncUsers();
	
	                        case 2:
	                            _context3.next = 4;
	                            return put({ type: 'asyncUserStatus' });
	        ...
	        asyncUserStatus: regeneratorRuntime.mark(function asyncUserStatus(_, _ref8) {
	            var put = _ref8.put;
	
	            var data, _data$data, status, error;
	
	            return regeneratorRuntime.wrap(function asyncUserStatus$(_context4) {
	                while (1) {
	                    switch (_context4.prev = _context4.next) {
	                        case 0:
	                            _context4.next = 2;
	                            return _webchat2.default.wechatUserAsyncUsersStatus();
	
	                        case 2:
	                            data = _context4.sent;
	                            _data$data = data.data, status = _data$data.status, error = _data$data.error;
	                            _context4.next = 6;
	                            return put({ type: 'payload', payload: { asyncStatus: status, asyncError: error } });
	            ...
	            }, asyncUserStatus, this);
	        }),
	        claarAsyncUserStatus: regeneratorRuntime.mark(function claarAsyncUserStatus(_, _ref9) {
	            var put = _ref9.put;
	            return regeneratorRuntime.wrap(function claarAsyncUserStatus$(_context5) {
	                while (1) {
	                    switch (_context5.prev = _context5.next) {
	                        case 0:
	                            _context5.next = 2;
	                            return _webchat2.default.wechatUserClearAsyncUsersStatus();
	            ...
	            }, claarAsyncUserStatus, this);
	        }),
	        getGroups: regeneratorRuntime.mark(function getGroups(_, _ref10) {
	            var put = _ref10.put;
	            var groups;
	            return regeneratorRuntime.wrap(function getGroups$(_context6) {
	                while (1) {
	                    switch (_context6.prev = _context6.next) {
	                        case 0:
	                            _context6.next = 2;
	                            return _webchat2.default.wechatUGroupList();
	        ...
	        moveUserToGroup: regeneratorRuntime.mark(function moveUserToGroup(_ref11, _ref12) {
	            var gid = _ref11.gid,
	                openid = _ref11.openid;
	            var put = _ref12.put;
	            return regeneratorRuntime.wrap(function moveUserToGroup$(_context7) {
	                while (1) {
	                    switch (_context7.prev = _context7.next) {
	                        case 0:
	                            _context7.next = 2;
	                            return _webchat2.default.wechatUGroupMoveUserToGroup({ id: gid, openid: openid });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css2 = __webpack_require__(159);
	
	var _row = __webpack_require__(158);
	
	var _row2 = _interopRequireDefault(_row);
	
	var _css3 = __webpack_require__(286);
	
	var _col = __webpack_require__(285);
	
	var _col2 = _interopRequireDefault(_col);
	
	var _css4 = __webpack_require__(68);
	
	var _button = __webpack_require__(65);
	
	var _button2 = _interopRequireDefault(_button);
	
	var _css5 = __webpack_require__(326);
	
	var _badge = __webpack_require__(325);
	
	var _badge2 = _interopRequireDefault(_badge);
	
	var _css6 = __webpack_require__(104);
	...
	var _RemarkModal = __webpack_require__(710);
	
	var _RemarkModal2 = _interopRequireDefault(_RemarkModal);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var Option = _select2.default.Option;
	exports.default = (0, _dva.connect)(function (_ref) {
	    var wechatUser = _ref.wechatUser,
	        remarkModal = _ref.remarkModal;
	    return { wechatUser: wechatUser, remarkModal: remarkModal };
	})(function (_ref2) {
	    var wechatUser = _ref2.wechatUser,
	        remarkModal = _ref2.remarkModal,
	        dispatch = _ref2.dispatch;
	    var page = wechatUser.page,
	        pageSize = wechatUser.pageSize,
	        list = wechatUser.list,
	        loading = wechatUser.loading,
	        total = wechatUser.total,
	        asyncStatus = wechatUser.asyncStatus,
	        asyncError = wechatUser.asyncError,
	        groups = wechatUser.groups;
	    ...
	    var columns = [{
	        ...
	        render: function render(text, record) {
	            return _react2.default.createElement('img', { src: record.headimgurl, width: 40, height: 40 });
	        }
	    }, {
	        title: '昵称',
	        key: 'nickname',
	        render: function render(text, record) {
	            return _react2.default.createElement(
	                'span',
	                null,
	                record.remark ? record.remark + ' \uFF08' + record.nickname + '\uFF09' : record.nickname
	            );
	        }
	    }, {
	        title: '性别',
	        ...
	        render: function render(text, record) {
	            return _react2.default.createElement(
	                _select2.default,
	                { defaultValue: record.groupid.toString(), style: { width: 120 }, onChange: function onChange(value) {
	                        dispatch({ type: 'wechatUser/moveUserToGroup', gid: value, openid: record.openid });
	                    } },
	                groups.map(function (d) {
	                    return _react2.default.createElement(
	                        Option,
	                        { value: d.gid.toString(), key: d.gid },
	                        d.name
	                    );
	                })
	            );
	    ...
	    var RemarkModalProps = _extends({}, remarkModal, {
	        onCancel: function onCancel() {
	            dispatch({ type: 'remarkModal/payload', payload: { visible: false } });
	        },
	        onOk: function onOk(data) {
	            dispatch({ type: 'remarkModal/set', data: data });
	        }
	    });
	
	    var AsyncUserBtn = function AsyncUserBtn() {
	        return _react2.default.createElement(
	            _col2.default,
	            { span: 4 },
	            function () {
	                switch (asyncStatus) {
	                    ...
	                    case '1':
	                        return _react2.default.createElement(
	                            _button2.default,
	                            { type: 'ghost', size: 'large', onClick: function onClick() {
	                                    return dispatch({ type: 'wechatUser/claarAsyncUserStatus' });
	                                } },
	                    ...
	                    case '2':
	                        return _react2.default.createElement(
	                            _button2.default,
	                            { type: 'ghost', size: 'large', onClick: function onClick() {
	                                    return dispatch({ type: 'wechatUser/asyncUserStatus' });
	                                } },
	                    ...
	                    case '3':
	                        return _react2.default.createElement(
	                            _button2.default,
	                            { type: 'danger', size: 'large', onClick: function onClick() {
	                                    confirm({
	                                        title: '清除错误状态吗？',
	                                        content: asyncError,
	                                        onOk: function onOk() {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(AsyncUserBtn, null)
	            )
	        ),
	        ...
	        remarkModal.visible ? _react2.default.createElement(_RemarkModal2.default, RemarkModalProps) : ''
	    );
	});
	module.exports = exports['default'];
...
//# sourceMappingURL=User.admin.chunk.js.map